...
public final class StatePackets {
    ...
    public static final class QueueEntry implements CinemarrMessage {
    ...
    public static final class AudioHealth implements CinemarrMessage {
    ...
    public static final class ManifestRequest implements CinemarrMessage {
    ...
    public static final class PlaybackState implements CinemarrMessage {
    ...
    public static final class StationState implements CinemarrMessage {
    ...
    public static final class AdventurePreview implements CinemarrMessage {
        private final long generation;
    ...
    public static final class ErrorMessage implements CinemarrMessage {

...
public final class TransportPackets {
    ...
    public static final class ChunkRequest implements CinemarrMessage {
    ...
    public static final class ChunkAcknowledgement implements CinemarrMessage {
    ...
    public static final class AudioManifest implements CinemarrMessage {
    ...
    public static final class AudioChunk implements CinemarrMessage {

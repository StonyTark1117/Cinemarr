...
import stonytark.cinemarr.core.model.StationModels.StationType;
...
public final class ControlPackets {
    ...
    public static final class ClientHello implements CinemarrMessage {
    ...
    public static final class ServerHello implements CinemarrMessage {
        private final int protocolVersion;
    ...
    public static final class TimeSyncRequest implements CinemarrMessage {
    ...
    public static final class TimeSyncResponse implements CinemarrMessage {
        private final long nonce;
        private final long clientSentEpochMs;
        private final long serverEpochMs;
    ...
    public static final class QueueRequest implements CinemarrMessage {
    ...
    public static final class ControlRequest implements CinemarrMessage {
    ...
    public static final class StationRequest implements CinemarrMessage {
    ...
    private static int boundedCount(WireInput input, int maximum, String field) {
        ...
        if (count < 0 || count > maximum) throw new ProtocolException("Cinemarr " + field + " count exceeds " + maximum);
        return count;
    }

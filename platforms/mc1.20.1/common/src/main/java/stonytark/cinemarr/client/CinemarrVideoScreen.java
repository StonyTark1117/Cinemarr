...
public final class CinemarrVideoScreen extends Screen {
    ...
    private void addControls(){
        ...
        widget("display-settings",Button.builder(Component.literal("Display"),b->minecraft.setScreen(new DisplaySettingsScreen(controllerPos,state,this))).bounds(layout.left(),4,68,14).build());

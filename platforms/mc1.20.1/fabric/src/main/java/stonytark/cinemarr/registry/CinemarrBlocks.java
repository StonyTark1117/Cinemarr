...
public final class CinemarrBlocks {
    ...
    public static void register(){Registry.register(BuiltInRegistries.BLOCK,id("screen_pixel"),SCREEN_PIXEL);Registry.register(BuiltInRegistries.BLOCK,id("tv_controller"),TV_CONTROLLER);Registry.register(BuiltInRegistries.BLOCK,id("tv_casing"),TV_CASING);Registry.register(BuiltInRegistries.BLOCK,id("tv_speaker"),TV_SPEAKER);Registry.register(BuiltInRegistries.BLOCK,id("redstone_receiver"),REDSTONE_RECEIVER);registerQuick("144p",QUICK_TV_144P);registerQuick("240p",QUICK_TV_240P);registerQuick("480p",QUICK_TV_480P);registerQuick("720p",QUICK_TV_720P);registerQuick("1080p",QUICK_TV_1080P);registerQuick("1440p",QUICK_TV_1440P);registerQuick("4k",QUICK_TV_4K);registerQuick("8k",QUICK_TV_8K);}

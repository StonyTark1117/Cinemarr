...
public final class CinemarrItems {
    ...
    public static void register(){Registry.register(BuiltInRegistries.ITEM,id("screen_pixel"),SCREEN_PIXEL);Registry.register(BuiltInRegistries.ITEM,id("tv_controller"),TV_CONTROLLER);Registry.register(BuiltInRegistries.ITEM,id("tv_casing"),TV_CASING);Registry.register(BuiltInRegistries.ITEM,id("tv_speaker"),TV_SPEAKER);}

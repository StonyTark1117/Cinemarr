...
public final class CinemarrItems {
    ...
    public static final BlockItem QUICK_TV_144P=quick(CinemarrBlocks.QUICK_TV_144P),QUICK_TV_240P=quick(CinemarrBlocks.QUICK_TV_240P),QUICK_TV_480P=quick(CinemarrBlocks.QUICK_TV_480P),QUICK_TV_720P=quick(CinemarrBlocks.QUICK_TV_720P),QUICK_TV_1080P=quick(CinemarrBlocks.QUICK_TV_1080P),QUICK_TV_1440P=quick(CinemarrBlocks.QUICK_TV_1440P),QUICK_TV_4K=quick(CinemarrBlocks.QUICK_TV_4K),QUICK_TV_8K=quick(CinemarrBlocks.QUICK_TV_8K);
    public static void register(){Registry.register(BuiltInRegistries.ITEM,id("screen_pixel"),SCREEN_PIXEL);Registry.register(BuiltInRegistries.ITEM,id("tv_controller"),TV_CONTROLLER);Registry.register(BuiltInRegistries.ITEM,id("tv_casing"),TV_CASING);Registry.register(BuiltInRegistries.ITEM,id("tv_speaker"),TV_SPEAKER);Registry.register(BuiltInRegistries.ITEM,id("redstone_receiver"),REDSTONE_RECEIVER);Registry.register(BuiltInRegistries.ITEM,id("tv_remote"),TV_REMOTE);registerQuick("144p",QUICK_TV_144P);registerQuick("240p",QUICK_TV_240P);registerQuick("480p",QUICK_TV_480P);registerQuick("720p",QUICK_TV_720P);registerQuick("1080p",QUICK_TV_1080P);registerQuick("1440p",QUICK_TV_1440P);registerQuick("4k",QUICK_TV_4K);registerQuick("8k",QUICK_TV_8K);}
    ...
    private static void registerQuick(String id,BlockItem item){Registry.register(BuiltInRegistries.ITEM,id("quick_tv_"+id),item);}

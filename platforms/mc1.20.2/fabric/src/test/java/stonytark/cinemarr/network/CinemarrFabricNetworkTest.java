...
class CinemarrFabricNetworkTest {
    @Test void protocolElevenHelloAndTimeSyncRoundTrip(){
        FriendlyByteBuf hello=new FriendlyByteBuf(Unpooled.buffer());new CinemarrPayloads.ClientHello(11).write(hello);
        assertEquals(new CinemarrPayloads.ClientHello(11),CinemarrPayloads.ClientHello.read(hello));

    ...
    void legacyAdapterConsumesTheSharedBrowseStationAndChunkVectors() {
        ...
        assertEquals(ProtocolGoldenVectors.STATION_REQUEST, hex(LegacyEnvelope.encodePayload(
                ...
                new ControlPackets.StationRequest(ControlPackets.StationAction.START_NOW,
                        stonytark.cinemarr.core.model.StationModels.StationType.SONIC_ADVENTURE, false, 12,
                        java.util.Collections.singletonList(new stonytark.cinemarr.core.model.StationModels.StationSeed(
                                stonytark.cinemarr.core.model.StationModels.ItemKind.TRACK, "42", "Song", "Artist"))))));

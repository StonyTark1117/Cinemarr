...
final class LegacyScreen extends GuiScreen {
    ...
    private void addBottomButtons(int left, int panel) {
        button(MUTE, left, height - 27, 68, 20, CinemarrSettings.enabled() ? "Mute" : "Unmute");
    ...
    @Override protected void actionPerformed(GuiButton button) {
        ...
        if (button.id == VOLUME_DOWN || button.id == VOLUME_UP) {
            ...
            CinemarrSettings.volume(CinemarrSettings.volume() + delta); CinemarrSettings.saveVolume(); initGui(); return;
        }
    ...
    @Override public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRendererObj, "Cinemarr", width / 2, 12, 0xFFFFFF);
        ...
        drawString(fontRendererObj, "Volume " + Math.round(CinemarrSettings.volume() * 100.0) + "%", left + 134, height - 21, 0xCFCFCF);

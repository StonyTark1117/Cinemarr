...
import stonytark.cinemarr.core.protocol.ByteArrayWireInput;
import stonytark.cinemarr.core.protocol.ByteArrayWireOutput;
import stonytark.cinemarr.core.protocol.ProtocolException;

/** One bounded FML payload containing a protocol-10 message identifier and canonical wire bytes. */

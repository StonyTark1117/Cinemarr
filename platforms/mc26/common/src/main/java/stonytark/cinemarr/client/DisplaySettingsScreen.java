...
final class Mc26DisplaySettingsScreen extends Screen implements stonytark.cinemarr.core.video.DisplaySettingsFeedback {
    ...
    @Override protected void init() {
        ...
        if (stonytark.cinemarr.core.protocol.ProtocolLimits.displayProbeEnabled())
            stonytark.cinemarr.Cinemarr.LOGGER.info("Acceptance display UI: width={} height={} editable={} qualityEditable={}", width, height, page.editable(), page.qualityEditable());
    ...
    @Override public void onClose(){if(!page.pending())CinemarrClientUi.showScreen(parent);}

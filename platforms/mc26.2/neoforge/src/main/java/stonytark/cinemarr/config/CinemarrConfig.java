...
public final class CinemarrConfig {
    ...
    public static final ModConfigSpec.ConfigValue<String> PLEX_TOKEN = SERVER_BUILDER
            .comment("Plex token. Prefer the CINEMARR_PLEX_TOKEN environment variable.")
            .define("plexToken", "");
    ...
    public static final ModConfigSpec.IntValue QUEUE_LIMIT = SERVER_BUILDER
            .comment("Maximum per-session video queue length. Cinemarr v1 caps this at 500 items.")
    ...
    public static final ModConfigSpec.BooleanValue ENABLED = CLIENT_BUILDER
            .comment("Listen to the server's Cinemarr stream by default.")
            .define("enabled", true);
    ...
    public static final ModConfigSpec.ConfigValue<String> VIDEO_DECODER_BACKEND =
            CLIENT_BUILDER.define("videoDecoderBackend", "software");
    public static final ModConfigSpec.ConfigValue<String> VIDEO_DECODER_DEVICE =

...
class CinemarrVideoTextureTest {
    @Test void detailedAdapterReleasesCpuRasterWithoutDroppingPausedSource() throws Exception {
        CinemarrVideoTexture texture=new CinemarrVideoTexture();
        var field=CinemarrVideoTexture.class.getDeclaredField("presented");field.setAccessible(true);

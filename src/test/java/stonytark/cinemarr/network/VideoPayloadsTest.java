...
class VideoPayloadsTest {
    ...
    @Test void browseAndManifestRoundTrip(){
        ...
        UUID session=UUID.randomUUID();VideoPackets.SegmentManifest manifest=new VideoPackets.SegmentManifest(session,1,640,360,"mpegts","h264","aac",1,List.of(new VideoPackets.SegmentDescriptor(0,0,1000,true,0,"")));

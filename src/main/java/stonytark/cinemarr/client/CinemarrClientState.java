...
public final class CinemarrClientState {
    ...
    public void accept(CinemarrMessage payload) {
        ...
        if (payload instanceof VideoPayloads.OpenVideoScreen value) {
            ...
            if (minecraft.screen instanceof CinemarrScreen screen) screen.stationChanged();
        } else if (payload instanceof CinemarrPayloads.AdventurePreview value) {
            adventurePreview = value;
            if (minecraft.screen instanceof CinemarrScreen screen) screen.adventurePreviewChanged();
            ...
            if (minecraft.player != null) minecraft.player.displayClientMessage(net.minecraft.network.chat.Component.literal("Cinemarr: " + value.message()), false);
            refreshScreen(minecraft);
            if (minecraft.screen instanceof CinemarrScreen screen) screen.requestFailed();
        }
    }

...
**Cinemarr 1.0 prerelease: checkpoint CI passed; final certification remains open.**

The [current ledger](1.0_CANDIDATE_LEDGER.md#verified-checkpoint-september-24)
and [September 24 manifest](RELEASE_CERTIFICATION_20260924.json) record the verified
`5e83b1e` checkpoint: two identical builds, sixteen artifacts, ten GameTests,
eighteen green hosted jobs and exact downloaded-bundle parity. Local acceptance
is 61/62 cases; Forge 1.20.2 initialization remains unresolved. Native decoder
acceptance is complete for the recorded bytes; real-Plex acceptance is 1/14.
Weather determinism and endpoint redaction repairs require fresh live checks.
The final containing commit still requires the full local gate, hosted CI,
artifact parity, remaining evidence review, scans and cleanup. No tag or
publication is authorized. The older sections below are historical.
